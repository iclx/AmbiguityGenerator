...
--
--   1) Large Doubles generated by the ambiguity generator will likely
--      be truncated to 0 as all large floats are divisible by powers of 2.
--   2) The split method isn't really well founded.
